...
I need to get back into Coho VCF stuff.  Diana demonstrated with the work in her
paper @Baetscher2017Microhaplotypes that microhaplotype loci have higher power 
for relationship inference. We have an existing VCF that's been working really well
for relationship inference (as far as I've hear from Libby), but we're trying to
add additional variants so it can serve as species ID between salmonids as well.  
